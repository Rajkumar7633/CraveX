...
func (h *AuthHandler) VerifyOTP(c *gin.Context) {
	...
	valid, err := h.otpService.VerifyOTP(req.PhoneNumber, req.Code)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *AuthHandler) SocialLogin(c *gin.Context) {
	...
	// In a real implementation, this would handle social login
	c.JSON(http.StatusOK, gin.H{"message": "social login implemented"})
}
...
func (h *AuthHandler) GetCurrentUser(c *gin.Context) {
	...
	user, err := h.authService.GetCurrentUser(userUUID)
	if err != nil {
...
func (h *AuthHandler) UpdateProfile(c *gin.Context) {
	...
	if err := h.authService.UpdateProfile(userUUID, &user); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *AuthHandler) DeleteAccount(c *gin.Context) {
	...
	if err := h.authService.DeleteAccount(userUUID); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
