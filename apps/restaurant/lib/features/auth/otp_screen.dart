...
class RestaurantOtpScreen extends ConsumerStatefulWidget {
  const RestaurantOtpScreen({super.key});
  @override
  ConsumerState<RestaurantOtpScreen> createState() => _RestaurantOtpScreenState();
}

class _RestaurantOtpScreenState extends ConsumerState<RestaurantOtpScreen> {
